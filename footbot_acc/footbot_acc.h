...
protected:
   ...
   UInt8 swarmConnection();
   Real GetMinObstacleDistance();
   void emitConsensus(CVector2& speed);
   Real computeNoise(Real);
   CRadians computeDegNoise(CRadians);
...
private:
   ...
   Real max_phi_gamma = 0; 

   Real P = 1; //kalman covariance
   CVector2 state;
   CVector2 filtered_state;

   UInt8 IDENTIFIER;
   int neighbors = 0;
   Real stabilizer_estimator;
   Real stabilizer = 1;
   CVector2 real_speed;
